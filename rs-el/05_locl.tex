...
\begin{frame}[label=current]{Floating Static Route}
	R1 has two paths to 10.0.0.0/8:
	\begin{itemize}
	...
	\begin{center}
		\begin{tikzpicture}[node distance=3cm]
			\node[draw,circle] (1)              {R1};
			\node[draw,circle] (2) [right of=1] {R2};
		...
		\end{tikzpicture}
	\end{center}
	\texttt{\pause\\)\#ip route 10.0.0.0 255.0.0.0 172.16.0.2\onslide<4->{ 10}
	        \pause\\)\#ip route 10.0.0.0 255.0.0.0 172.17.0.2\pause~20
	}
\end{frame}
